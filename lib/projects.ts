...
export const projects: Project[] = [
  {
    ...
    longDescription: 'Designed and developed the full UI/UX from scratch, creating an intuitive interface for AI-driven startup analysis using Tailwind CSS. Built and integrated a conversational AI chatbot into the backend infrastructure, enabling users to interact with startup data in natural language. Managed end-to-end full-stack development, handling both frontend and backend architecture independently. Engineered structured data pipelines for TensorFlow/PyTorch model inputs, improving model efficiency and overall system performance.',
